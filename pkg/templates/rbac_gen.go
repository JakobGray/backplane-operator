...
//+kubebuilder:rbac:groups=route.openshift.io,resources=routes,verbs=create;get
...
//+kubebuilder:rbac:groups=agent-install.openshift.io,resources=agents;infraenvs,verbs=list;watch
...
//+kubebuilder:rbac:groups=,resources=events,verbs=create;patch
//+kubebuilder:rbac:groups=,resources=configmaps,verbs=get;list;watch
//+kubebuilder:rbac:groups=,resources=secrets,verbs=create;deletecollection;get;list;patch;update;watch
